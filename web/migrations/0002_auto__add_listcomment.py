...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ListComment'
        db.create_table(u'web_listcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.User'])),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.List'])),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'web', ['ListComment'])


    def backwards(self, orm):
        # Deleting model 'ListComment'
        db.delete_table(u'web_listcomment')
